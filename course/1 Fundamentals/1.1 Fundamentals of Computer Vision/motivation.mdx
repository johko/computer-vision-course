...
Shockingly we don't need any formal education for this. We don't attend classes for most of the decisions we make daily. There is no mental math 101 to estimate the foot strength required for kicking a ball. We learned that from trial or error. growing up. And, some of us might never have learned at all. This is a striking contrast to the way we built programs. Programs are mostly rule-based.
