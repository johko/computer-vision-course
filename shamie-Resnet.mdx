...
The obstacle to answering this question, the "gradient vanishing problem", was addressed by Normalised initializations and intermediate normalization layers.
