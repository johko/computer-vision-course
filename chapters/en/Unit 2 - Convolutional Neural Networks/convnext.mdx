...
[Block Comparison](./block_comparison.png)
...
[Inverted Bottleneck Comparison](./inverted_bottleneck.png)
...
[Moving up the Depth Conv Layer](./depthwise_moveup.png)
...
## Model Code
You can go to [this HuggingFace documentation](https://huggingface.co/docs/transformers/model_doc/convnext) to learn more about how to use ConvNext in your code.
