...
Let's make a distinction between the concepts we are talking about. The trombone player needs no training to play the tannerin, he already knows how to do it unbeknownst to him. The saxophone player needs some training to fine-tune his skills to play the tannerin. In deep learning terms, what the trombone player does is use a model out-of-the-shelf. This is called transfer learning. The training of a model that needs more time to learn, like our saxophone player, is called fine-tuning. 
