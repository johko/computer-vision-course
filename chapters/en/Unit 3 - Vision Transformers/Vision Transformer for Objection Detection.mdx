...
To deepen your understanding of the ins-and-outs of object detection, check out our [dedicated chapter](https://github.com/johko/computer-vision-course/blob/main/chapters/en/Unit%206%20-%20Basic%20CV%20Tasks/object_detection.mdx) on Object Detection 🤗

### The Need to Fine-tune Models in Object Detection? 🤔

That is an awesome question. Before reading the answer, check out our definitions of fine-tuning and how it differs from transfer learning [here](https://book.premai.io/state-of-open-source-ai/fine-tuning/#transfer-learning-versus-fine-tuning).
...
In simple terms, augmentations are some set of random transformations like rotations, resizing etc. These are applied to get more samples and to make the vision model more robust towards different conditions of the image.

We will use the [albumentations](https://github.com/albumentations-team/albumentations) library to achieve this. If you want to dig deeper into different types of augmentations, check out the [awesome tutorial on albumentations](https://albumentations.ai/docs/examples/example_bboxes/) to learn more. Let's create some random transformations using albumentations.
