...
However in the case of self separable attention, these two batchwise multiplications are replaced by two separate linear computations. This allows for further boosted inference speed. 
