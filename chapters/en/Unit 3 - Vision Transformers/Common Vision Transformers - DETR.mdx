...
<br/><br/><img src="https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/DETR_FeatureMaps.png" alt="Feature Maps of Encoder" width="100%"><br/>
_**Left**: 12 out of 256 Dimensions in the Feature Map Visualized. Each dimension extract some features of the original cat image, while downsizing the original image. Some dimensions have higher focus on the patterns on the cat, some have a higher focus on the bed sheets. <br>**Right**: Keeping the original feature dimension of size 256, the width and height are further downsized and flattened into size 850._<br/><br/>
