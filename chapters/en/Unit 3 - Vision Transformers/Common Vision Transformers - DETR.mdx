...
DETR is mainly used for object detection tasks, which is the process of detecting objects in an image. For example, the input of the model would be an image of a road, and the output of the model could be `[('car',X1,Y1,W1,H1),('pedestrian',X2,Y2,W2,H2)]`, in which X, Y, W, H represent the x, y positions, width and height respectively. \
...
## Evolution of DETR
### Deformable DETR
Two of the main problems of DETR is a long and slow process of convergence, and suboptimal small object detection. \
...
[4] [Conditional DETR](https://arxiv.org/abs/2108.06152) \
[5] [Deformable DETR](https://arxiv.org/abs/2010.04159) \
[6] [`facebook/detr-resnet-50`](https://huggingface.co/facebook/detr-resnet-50)
