...
We hope that you found the ImageNet Roulette case study interesting and what can go wrong with AI models in general. In this chapter, we will go through yet another example of a powerful technology which has cool applications but can also raise ethical concerns if kept unchecked. Let's first quickly summarize the ImageNet Roulette case study and its after effects.
