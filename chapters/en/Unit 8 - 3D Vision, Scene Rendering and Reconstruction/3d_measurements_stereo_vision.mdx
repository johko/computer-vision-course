...
A total of 12 points are selected in the scene and their (u,v) values in the left and right images are tabulated below. Using, equations 4, 5 and 6, (x,y,z) coordinates for these points are also calculated and tabulated below. X and Y coordinates are with respect to the left camera and origin is at the pinhole(/optical center of the lens) of the left camera. Therefore, 3D points left and/or above the pinhole have negative X and/or Y values respectively.
