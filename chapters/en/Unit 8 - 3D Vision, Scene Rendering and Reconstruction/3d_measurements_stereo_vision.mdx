...
For all other positions and orientations of the new camera location, the 2 lines in 3D must intersect at exactly 1 point, which is where point P must lie. 
