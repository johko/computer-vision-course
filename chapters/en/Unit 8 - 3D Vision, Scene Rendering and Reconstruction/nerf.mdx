...
An important leap would be NVIDIA's [Instant-ngp](https://nvlabs.github.io/instant-ngp/), which introduces innovative techniques that efficiently encode input data. 
...
[Mipnerf-360](https://jonbarron.info/mipnerf360/) is also worth mentioning since it introduced a scene contraction that allows us to represent scenes that are unbounded in all directions, which is important for real-world applications. 
