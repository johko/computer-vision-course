...
Humans explore the world through senses diverse-sight, sound, touch, and scent. A complete grasp of surroundings emerges by harmonizing insights from these varied modalities.
I think of modality which was initially introduced in mathematics as distinct peaks, in a poetic way as : "With each modality, a unique part to play,
...
In pursuit of making a capable AI to understand the world, the field of machine learning seeks to cultivate models capable of processing and 
...
In VLM's we use this paradigm and extend for combining visual images to get to our desired results. 
For example, in 2021 OpenAI lead to the very strong paper called [CLIP](https://openai.com/research/clip) which led to the
major utilization of the this style where they employs an imagetext contrastive objective and learns by pulling 
the paired images and texts close and pushing others faraway in the embedding space. In this way, the pre-trained 
VLM's capture rich vision-language correspondence knowledge and can perform zero-shot predictions by matching
the embeddings of any given images and texts. It turns out they beat the Imagenet models on out-of-distribution
tasks. You can read more on CLIP and such awesome models in our next section of this Chapter!
...
## Strategies
We can also [group](https://lilianweng.github.io/posts/2022-06-09-vlm/#no-training) VLM's as per how we utilise the two modes for learning. 
