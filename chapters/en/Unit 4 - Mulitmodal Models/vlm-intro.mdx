...
It is designed to let us think as if the results of models look really amazing and they are way better than previous models but does it understand compositional relationships
in the same way humans would understand it rather than just generalizing to the data. For example, earlier version of Stable Diffusion was
