# Welcome to Community Computer Vision Course

Welcome to Community Computer Vision Course! This course is prepared and continuously improved by the community for the community 🤗 

### To start learning ✍️

Simply head over [huggingface.co/learn](http://huggingface.co/learn) and start studying the chapters.
...
There are notebooks under Notebooks/Vision Transformers section. As of now, we have notebooks for object detection, image segmentation and image classification. You can either train a model on a dataset that exists on 🤗 Hub or upload a dataset to a dataset repository and train a model on that. 
...
1. If you trained a model with transformers and pushed it to Hub, the model card will be generated. In that case, edit the card and fill in more details. 
2. Add the dataset’s id to model card to link the model repository to the dataset repository.

### Creating a Space

This part of the assignment involves building a Gradio based application to your computer vision model, and sharing it on 🤗 Spaces.

You can get started with Gradio here https://huggingface.co/learn/nlp-course/chapter9/1?fw=pt#introduction-to-gradio 

You can learn about how to share your application on 🤗 Spaces here https://huggingface.co/learn/nlp-course/chapter9/4?fw=pt

### Certification 🥇

You need to fill the [form](https://forms.gle/JaSYEf1pEZ4HtNKGA) here with your name, e-mail, and links to your model and Space repositories. https://forms.gle/JaSYEf1pEZ4HtNKGA
...
This is made by the Hugging Face Community with love! Our goal was to create a computer vision course that is begginer friendly and that could act as ressource for other people. Around 60+ people from all over the world joined forces to make this project happen. Here we highlight their efforts:
 ...
 **Unit 2 - Convolutional Neural Networks (CNNs)** 
 - Reviewers: [Mohammed Hamdy](https://github.com/mmhamdy), [Sezan](https://github.com/sezan92), [Joshua Adrian Cahyono](https://github.com/JvThunder), [Murtaza Nazir](https://github.com/themurtazanazir), [Albert Kao](https://github.com/albertkao227) 
 - Writers: [Emre Albayrak](https://github.com/emre570), [Caroline Shamiso Chitongo](https://github.com/ShamieCC), [Sezan](https://github.com/sezan92), [Joshua Adrian Cahyono](https://github.com/JvThunder), [Murtaza Nazir](https://github.com/themurtazanazir), [Albert Kao](https://github.com/albertkao227)
 ...
 **Unit 4 - Multimodal Models** 
 ...
 - Writers: [Snehil Sanyal](https://github.com/snehilsanyal), [Surya Guthikonda](https://github.com/SuryaKrishna02), [Mateusz Dziemian](https://github.com/mattmdjaga), [Charchit Sharma](https://github.com/charchit7), [Evstifeev Stepan](https://github.com/minemile), [Jeremy Kespite](https://github.com/jeremy-k3/)
...
- Writers: [John Fozard](https://github.com/jfozard)
 ...
 **Unit 11 - Zero Shot Computer Vision** 
 - Reviewers: [Mohammed Hamdy](https://github.com/mmhamdy)
 - Writers: [Mohammed Hamdy](https://github.com/mmhamdy) Writer and Reviewer: [Albert Kao](https://github.com/albertkao227)
 ...
 **Unit 13 - Outlook and Emerging Trends** 
 ...
 - Writers: [Farros Alferro](https://github.com/farrosalferro), [Mohammed Hamdy](https://github.com/mmhamdy)
