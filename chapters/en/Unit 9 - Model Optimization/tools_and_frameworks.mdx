...
For a hands-on guide on how to use the Tensorflow Model Optimization Toolkit, refer this [notebook](/notebooks/Unit 9 - Model Optimization/tmo.ipynb)
...
For a hands-on guide on how to use the Pytorch Quantization, refer this [notebook](/notebooks/Unit 9 - Model Optimization/torch.ipynb)
...
For a hands-on guide on how to use the ONNX Runtime, refer this [notebook](/notebooks/Unit 9 - Model Optimization/onnx.ipynb)
...
For a hands-on guide on how to use the TensorRT, refer this [notebook](/notebooks/Unit 9 - Model Optimization/tensorrt.ipynb)
...
For a hands-on guide on how to use the OpenVINO, refer this [notebook](/notebooks/Unit 9 - Model Optimization/openvino.ipynb)
...
For guide on how to setup and use EdgeTPU, refer this [notebook](/notebooks/Unit 9 - Model Optimization/edge_tpu.ipynb)
