...
| Dataset Name              | Year | Description                                                  | Paper | Code | Additional Links |
| ------------------------- | ---- | ------------------------------------------------------------ | ----- | ---- | ---------------- |
| Tsukuba CG Stereo Dataset |      | This dataset includes 1800 stereo pairs accompanied by ground truth disparity maps, occlusion maps, and discontinuity maps, all of which are crucial for developing and evaluating stereo matching algorithms' performance. |       |      |                  |
...
| Surreal      | 2017         | Large-scale dataset with synthetically-generated but realistic images of people | [Code](https://github.com/gulvarol/surreal), [Paper](https://arxiv.org/abs/1701.01370), [Project](https://www.di.ens.fr/willow/research/surreal/) |
...
### 3D Model Repository - Do you want to keep this section?
