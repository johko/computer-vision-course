...
We will render our synthetic data in Google Colab. The first step is to clone the offical [BlenderProc](https://github.com/DLR-RM/BlenderProc) repository.
...
<Tip warning={true}>
  Installing Blender can take a while. Please be patient!
</Tip>
...
We are all set now to render our data. We are going to demo the basic example provided by the BlenderProc library. When we run this command, BlenderProc will render rgb, normals and depth.
