...
It encompasses a wide range of features, making it a versatile tool for artists, animators, and developers. Let's start off by
walking through a basic example of rendering a synthetic image of an elephant.

Here are the essential steps:

- Create the elephant model (the one shown was created with the Metascan app using Photogrammetry).
