...
As previously mentioned, there are several 3D rendering engines that you can use for PBR. We are going to focus on Blender because it is open source and there are a lot of resources available about Blender.
...
<div class="flex justify-center">
    <img src="https://huggingface.co/datasets/hf-vision/course-assets/resolve/main/synthetic-data-creation-PBR/rendered_elephant.png" alt="Synthetic Elephant Image">
</div>
...
You can check out this notebook to try BlenderProc in Google Colab, or the demos with basic examples provided [here](https://github.com/DLR-RM/BlenderProc/tree/main/examples/basics).
...
- [3D Menagerie: Modeling the 3D Shape and Pose of Animals](https://arxiv.org/abs/1611.07700)
- [Fake It Till You Make It: Face analysis in the wild using synthetic data alone](https://arxiv.org/pdf/2109.15102.pdf)
