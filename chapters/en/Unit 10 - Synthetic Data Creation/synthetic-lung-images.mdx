...
![trainig-gif](https://huggingface.co/datasets/hf-vision/course-assets/blob/main/dcgan_training_animation.gif)

## How did we do?

Here are 64 "good" synthetic images, defined as receiving a "real" label from the discriminator with a 70% probability.

![lung-images](https://huggingface.co/datasets/hf-vision/course-assets/blob/main/good_images.png)
...
[[./Synthetic_lung_images_hf_course.ipynb]]
