...
# Let's Start working on Point-Clouds
...
There is more information also available in the [point-cloud-utils](https://github.com/fwilliams/point-cloud-utils) library itself!
...
Why dont you, as practice, try to load some 
