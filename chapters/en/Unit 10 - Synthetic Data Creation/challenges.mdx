...
Before using synthetic data to train a model, there are some questions that need to be answered.

## Does the Dataset Adequately Represent Reflect Real World Data?
...
## Does the Dataset Reflect the Real World Diversity?
