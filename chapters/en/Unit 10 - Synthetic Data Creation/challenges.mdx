...
or may be different in the real world. A good practice is to evaluate your dataset using a measure such as FID, IS, or CAS.

_Classification Accuracy Score (CAS):_
