...
```python
!pip install diffusers # Install diffusers library if you haven't already
from diffusers import StableDiffusionXLPipeline
import torch

model = "stabilityai/stable-diffusion-xl-base-1.0"
pipe = StableDiffusionXLPipeline.from_pretrained(model,torch_dtype=torch.float16)
pipe.load_lora_weights("lora_weights.safetensors") # Civitai
pipe.load_lora_weights("ostris/crayon_style_lora_sdxl") # Hugging Face
