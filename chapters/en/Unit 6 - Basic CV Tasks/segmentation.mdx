...
You have now seen how to use a segmentation model, but how can you evaluate it ? Segmentation as show in the previous section in mainly 
supervised learning tasks. Therefore, the dataset is composed of images and their corresponding masks that are your ground truth. A few metrics
can be used to evaluate your model. The most common ones are:
