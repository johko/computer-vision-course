...
Vision Transformers (ViTs), on the other hand, turned out to be more accurate, scalable and architecturally simple models that took computer vision by storm when introduced. However, this simplicity comes at a cost: they lack this “vision inductive bias” (their architecture is not designed to work specifically with visual data).
