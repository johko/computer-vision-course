...
So far so good, now to I-JEPA. As a start, the picture below from the I-JEPA paper show the difference between Joint-Embedding methods, generative methods, and I-JEPA.
...
The target-encoder, context-encoder, and the predictor are use a Vision Transformer (ViT) architecture. You have a refresher about them in unit 3 of this course.
...
2. I-JEPA is competitive with view-invariant pretraining approaches on semantic tasks and achieves better performance on low-level visions tasks such as object counting and depth prediction.
...
- [I-JEPA offical github repository](https://github.com/facebookresearch/ijepa)
