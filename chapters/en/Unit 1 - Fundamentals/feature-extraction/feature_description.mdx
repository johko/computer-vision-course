...
1. [Introduction to SIFT (Scale-Invariant Feature Transform)](https://docs.opencv.org/4.x/da/df5/tutorial_py_sift_intro.html)
...
- [Medium Blogpost - Introduction to SURF ](https://medium.com/@deepanshut041/introduction-to-surf-speeded-up-robust-features-c7396d6e7c4e)
  ...
  2.[OpenCV Tutorial - Introduction to SURF (Speeded-Up Robust Features)] (https://docs.opencv.org/3.4/df/dd2/tutorial_py_surf_intro.html)

3. [Journal Paper - Feature Extraction Using SURF Algorithm for Object Recognition](https://www.ijtra.com/view/feature-extraction-using-surf-algorithm-for-object-recognition.pdf)
