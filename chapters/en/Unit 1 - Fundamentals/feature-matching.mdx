...
_First we create a dictionary to specify the algorithm:_
...
_We also create a disctionary to specify the number of specifies the maximum leafs to visit:_
...
3. Define the FLANN parameters.  Trees is the bins you want to sort into.
...
4. Need to draw only good matches, so create a mask
