...
](https://huggingface.co/datasets/hf-vision/course-assets/resolve/743a2a115b53f258c9e6bc7744534d9e03b8a124/motivation_01.png)
...
Shockingly we don't need any formal education for this. We don't attend classes for most of the decisions we make daily. There is no mental math 101 to estimate the foot strength required for kicking a ball. We learned that from trial and error growing up. And, some of us might never have learned at all. This is a striking contrast to the way we built programs. Programs are mostly rule-based.
 ...
 ![What is a ball? Comparing a shuttlecock with a soccer ball, a football, a volleyball, a cricket ball and a zorb ball.](https://huggingface.co/datasets/hf-vision/course-assets/resolve/743a2a115b53f258c9e6bc7744534d9e03b8a124/motivation_02.png)
...
We could do a tentative definition and say  “A ball is a sphere-like object used in sports or in play”. It seems correct, but we run into another problem. How do you know they are playing a sport?  What do you use to detect that they are doing so? What if it was a dog with a ball? Is that not a ball? What if it is a ball on its own, with no people, and no sports? But what about something like the shuttlecock? It is something that we use to play with, that is not perfectly spherical, but we do not consider it a ball. All those nuances add up so that a simple problem that humans solve unconsciously is already hard to break down into simple rules.
 ...
 ![A ball covered with feathers](https://huggingface.co/datasets/hf-vision/course-assets/resolve/743a2a115b53f258c9e6bc7744534d9e03b8a124/motivation_04.png)
...
](https://huggingface.co/datasets/hf-vision/course-assets/resolve/743a2a115b53f258c9e6bc7744534d9e03b8a124/motivation_03.gif)
