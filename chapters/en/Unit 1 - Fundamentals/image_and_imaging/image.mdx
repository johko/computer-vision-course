...
That is not the only way one can create an image.  Sometimes, they are created by computers with or without the help of AI.  We have a dedicated chapter for images with a little helping hand from AI. Most of the terminology we will introduce here will still be applied.
