...
Now that we have seen what are images, how they are acquired and their impact, it is time to understand what are the operations we can perform them and how they are used during the model building process. 
