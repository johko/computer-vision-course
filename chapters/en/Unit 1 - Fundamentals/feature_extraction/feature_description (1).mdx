...
2. **Distinctivness:** A good descriptor captures unique information about the object. It should be able to discriminate between different objects or parts of image and be distinct enough to differentiate them from similar elements.
