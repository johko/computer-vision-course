...
But Anyway, In this unit we are going to address *only* embedding-based methods, and to be more specific **attention-based embedding-based methods**. Zero-shot learning is a big topic and a comprehensive coverage may require a course of its own. Interested readers may check the provided additional readings and have fun.
...
- **Open Set Recognition (OSR)**: Think of it as a Boolean Zero-shot Learning. Like ZSL, in OSR problem the model handles both seen and unseen classes. But unlike ZSL, the model only need to classify, at test time, whether the instance belongs to the seen classes or not. That’s it, no fancy labels.Still, this is a significant challenge.
...
[^1]: A fast learning algorithm for deep belief nets, [Link](https://dl.acm.org/doi/10.1162/neco.2006.18.7.1527)
[^2]: Zero-Shot Learning Through Cross-Modal Transfer, [Link](https://arxiv.org/abs/1301.3666)
[^3]: Semantic Autoencoder for Zero-Shot Learning, [Link](https://arxiv.org/abs/1704.08345)
[^4]: Language Models are Few-Shot Learners, [Link](https://arxiv.org/abs/2005.14165)
[^5]: Learning Transferable Visual Models From Natural Language Supervision, [Link](https://arxiv.org/abs/2103.00020)
[^6]: Learning Structured Output Representation using Deep Conditional Generative Models, [Link](https://papers.nips.cc/paper_files/paper/2015/hash/8d55a249e6baa5c06772297520da2051-Abstract.html)