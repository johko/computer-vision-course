...
- 3. Present studied results of ZSL algorithm performance comparisons.  
...
### Enable ZSL with Semantic Embeddings  
...
New ZSL methods are proposed every year, and it is hard to determine which method worked best due to their distinct evaluation processes. In paper [7] the authors proposed a unified evaluation protocol to train and test various ZSL methods with identical datasets and provide a more objective comparison. The popular datasets used for ZSL benchmark and evaluation are:
...
- [7] Xian et al., Zero-Shot Learning - The Good, the Bad and the Ugly, CVPR (2017).
- [8] Radford et al., Learning Transferable Visual Models From Natural Language Supervision, arXiv (2021). 
